    ...
    render() {
        ...
        <div>
            ...
            <div className="pageWrapper">
                ...
                {/* Page header */}
                <div className="pageHeader">Data Log</div>
                                              ...
                                              <li className="list-group-item mainContentTextBlack calorieDataListGroupItem" key={result._id}>
                                                <Row>
                                                  <Col size="col-md-12" className="text-justify">
                                                    ...
                                                    <Br2 />
                                                    <Br2 />
                                                    Time: {result.mealtype.substring(3, 20)}<br />
                                                    Pee color: {result.pee}<br />
                                                    Poop color: {result.poop}<br />
                                                    Nursed breast: {result.breast}<br />
                                                    Duration: {result.breastduration}<br />
                                                    Formula amount: {result.formulaamount}<br />
