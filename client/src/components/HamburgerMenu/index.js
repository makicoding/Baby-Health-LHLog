      ...
      <div>
        ...
        <div id="myNav" className="overlay">
          ...
          <div className="overlay-content">
            ...
            <Link to="/DataEntry" className={this.getMenuItemClasses("/DataEntry")}>Data Entry</Link>
            <Link to="/DataLog" className={this.getMenuItemClasses("/DataLog")}>Data Log</Link>
        ...
        <div className="topBar">
          ...
          <a className="branding" href="/">Baby Health</a>
        </div>
