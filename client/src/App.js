    ...
    <Router>
      <div>
        <Switch>
          ...
          <Route exact path="/DataEntry" component={CalorieEntry} />
          <Route exact path="/DataEntryEdit" component={CalorieEntryEdit} />
          <Route exact path="/DataLog" component={CalorieData} />
